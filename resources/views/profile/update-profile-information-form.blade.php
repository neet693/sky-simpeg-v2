<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Employee Number -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="employee_number" value="{{ __('Employee Number') }}" />
            <x-input id="employee_number" type="text" class="mt-1 block w-full" wire:model="state.employee_number"
                required autocomplete="employee_number" />
        ...
        <!-- Date of Birth -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="birth_date" value="{{ __('Date of Birth') }}" />
            <x-input id="birth_date" type="date" class="mt-1 block w-full" wire:model="state.birth_date" required
