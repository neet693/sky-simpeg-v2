<aside class="sidebar">
    ...
    <!-- Dropdown Menu Birokrasi -->
    <div class="dropdown">
        <a href="#" class="sidebar-item" onclick="menuBirokrasi()">
            ...
            <span>Menu Birokrasi</span>
        </a>

        <!-- Dropdown Content -->
        <div class="birokrasi-content">
            <a href="{{ route('assignments.index') }}"
                class="sidebar-item {{ request()->routeIs('assignments.index') ? 'active' : '' }}"
                onclick="toggleActive(this)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('leaves.index') }}"
                class="sidebar-item {{ request()->routeIs('leaves.index') ? 'active' : '' }}"
                onclick="toggleActive(this)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- Dropdown Menu Akun -->
    <div class="dropdown">
        <a href="#" class="sidebar-item" onclick="menuAkun()">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="akun-content">
            <a href="{{ route('employee.show', ['employee_number' => auth()->user()->employee_number]) }}"
                class="sidebar-item{{ request()->routeIs('employee.show') && request()->route('employee_number') == auth()->user()->employee_number ? ' active' : '' }}"
                onclick="toggleActive(this)">
...
<script>
    function menuBirokrasi() {
        const birokrasiContent = document.querySelector('.birokrasi-content');
        birokrasiContent.classList.toggle('show');
    }

    function menuAkun() {
        const akunContent = document.querySelector('.akun-content');
        akunContent.classList.toggle('show');
    }
    // This function can be used for other sidebar items to toggle the active state
    function toggleActive(element) {
        const activeElement = document.querySelector('.sidebar-item.active');
        if (activeElement) {
